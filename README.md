Here is a complete, professional, and GitHub-ready \*\*`README.md`\*\* file tailored specifically to the firmware you built. It includes all the features, setup steps, troubleshooting tips, and keyboard shortcut tables we worked on.



You can copy and paste the code block below directly into your repository's `README.md` file!
...
const unsigned char AES\_KEY\[16] = { 
